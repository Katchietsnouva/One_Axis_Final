...
class Switch(tk.Canvas):
    def __init__(self, master=None, **kwargs):
        # Extract the custom options before passing them to tk.Canvas
        self.width = kwargs.pop('width', 60)
        self.height = kwargs.pop('height', 30)
        self.background_color = kwargs.pop('background_color', 'lightgray')
        self.switch_color = kwargs.pop('switch_color', 'green')
        self.state = kwargs.pop('state', 'off')
